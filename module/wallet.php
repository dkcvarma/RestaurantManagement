...
<div class="wrapper">
    ...
    <div class="main-panel">
		<nav class="navbar navbar-default">
            <div class="container-fluid" style="background-image: url('../img/w1.jpg');">
                <div class="navbar-header">
                    ...
                    <p class="navbar-brand" style="color:white;">BALANCE : <i class="fa fa-inr"></i><?php echo $balance ?></p>
                </div>
		...
		<div >
			<div style="position:relative;">
				<iframe style="position:absolute;top:0px;width:105%;height:105vh;" frameborder="0" src="wallet/index1.php"></iframe>
			</div>
		</div>
