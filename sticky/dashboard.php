...
$document_get = mysqli_query($connection,"SELECT * FROM user WHERE username='$username'");
...
?>
<br/>
 <div style="margin-left:-25%;"> <a href="#addnote" role="button" class="btn" data-toggle="modal">Add Note</a> </div><br/><br/> 
